...
//      this.style.color = "red";
    ...
    */
    ...
    elbottom.className="mx-5 float-left"
    ...
    this._tags.className="flex relative"
    this._tags.style.cssText = "top: -8px;"
    if(tag.includes('QA'))
    {
      this._tags.innerHTML += `<div class="mt-2 flex-none items-center text-sm text-gray-500 ">
    ...
    this.style.cssText = "position: relative; left: -17px;top: -28px;"
    this.append(el)
